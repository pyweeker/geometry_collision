...
fn main() {
    App::new()
        ...
        .add_system(change_draw_mode_systemA)
        .add_system(change_draw_mode_systemB)
        .add_system(change_draw_mode_systemC)

        .add_system(change_number_of_sidesA)
        .add_system(change_number_of_sidesB)
        .add_system(change_number_of_sidesC)

        .add_system(rotate_shape_systemA)
        .add_system(rotate_shape_systemB)
        .add_system(rotate_shape_systemC)

        .add_system(move_shape_systemA)
        .add_system(move_shape_systemB)
        .add_system(move_shape_systemC)

        .add_system(scale_shape_systemA)
        .add_system(scale_shape_systemB)
        .add_system(scale_shape_systemC)
        .run();
}

#[derive(Component)]
struct ExampleShapeA;  // Enums ShapeVarA, ShapeVarB, ShapeVarC  ???


#[derive(Component)]
struct ExampleShapeB; 

#[derive(Component)]
struct ExampleShapeC; 


//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
fn move_shape_systemA(mut query: Query<&mut Transform, With<ExampleShapeA>>, time: Res<Time>) {
...
fn scale_shape_systemA(mut query: Query<&mut Transform, With<ExampleShapeA>>, time: Res<Time>) {
    let delta = time.delta_seconds();
...
fn rotate_shape_systemA(mut query: Query<&mut Transform, With<ExampleShapeA>>, time: Res<Time>) {
    let delta = time.delta_seconds();
...
fn change_draw_mode_systemA(mut query: Query<&mut DrawMode, With<ExampleShapeA>>, time: Res<Time>) {
...
fn change_number_of_sidesA(mut query: Query<&mut Path, With<ExampleShapeA>>, time: Res<Time>) {
